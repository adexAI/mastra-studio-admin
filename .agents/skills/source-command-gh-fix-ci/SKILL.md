---
name: "source-command-gh-fix-ci"
description: "Run the migrated source command `gh-fix-ci`."
---

# source-command-gh-fix-ci

Use this skill when the user asks to run the migrated source command `gh-fix-ci`.
...
Migrated from source command `gh-fix-ci` into a Codex skill. Invoke it as `$source-command-gh-fix-ci`.
