---
name: "source-command-gh-new-pr"
description: "Run the migrated source command `gh-new-pr`."
---

# source-command-gh-new-pr

Use this skill when the user asks to run the migrated source command `gh-new-pr`.
...
Migrated from source command `gh-new-pr` into a Codex skill. Invoke it as `$source-command-gh-new-pr`.
