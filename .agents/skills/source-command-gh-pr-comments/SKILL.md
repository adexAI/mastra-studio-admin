---
name: "source-command-gh-pr-comments"
description: "Run the migrated source command `gh-pr-comments`."
---

# source-command-gh-pr-comments

Use this skill when the user asks to run the migrated source command `gh-pr-comments`.
...
Migrated from source command `gh-pr-comments` into a Codex skill. Invoke it as `$source-command-gh-pr-comments`.
